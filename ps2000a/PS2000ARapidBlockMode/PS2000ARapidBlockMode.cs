...
namespace PS2000AExample
{
    ...
    {
        public Imports.CouplingType DCcoupled;
        public Imports.Range range;
        public bool enabled;
    }
    class PS2000ARapidBlockMode
    {
        bool _ready = false;
        short _handle;
       ...
       ****************************************************************************/
        ...
        public PS2000ARapidBlockMode(short handle)
        {
            _handle = handle;
        }
        ...
        {
            Console.WriteLine("PicoScope 2000 series (ps2000a) Driver C# Rapid block mode example");
            Console.WriteLine("\n Opening the device...");
            ...
            WaitForKey();
            PS2000ARapidBlockMode RapidCapture = new PS2000ARapidBlockMode(handle);
        ...
        {
            {
                ...
                for (int i = 0; i < MAX_CHANNELS; i++)
                {
                    ...
                    _channelSettings[i].DCcoupled = Imports.CouplingType.PS2000A_DC;

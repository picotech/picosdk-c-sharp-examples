...
namespace ProbeScaling
{
    ...
    class Scaling
    {
        ...
        new PicoProbeScaling(){ ProbeEnum = PicoConnectProbes.PicoConnectProbes.PicoConnectProbeRange.PICO_X1_PROBE_20V, Probe_Range_text = "20V",    MinScale = -20,   MaxScale = 20,   Unit_text =  "V"},
        ...
        new PicoProbeScaling(){ ProbeEnum = PicoConnectProbes.PicoConnectProbes.PicoConnectProbeRange.PICO_D9_BNC_20V, Probe_Range_text = "D9_BNC_20V",    MinScale = -20,   MaxScale = 20,   Unit_text =  "V"},
        ...
        new PicoProbeScaling(){ ProbeEnum = PicoConnectProbes.PicoConnectProbes.PicoConnectProbeRange.PICO_D9_2X_BNC_20V, Probe_Range_text = "D9_2X_BNC_20V",    MinScale = -20,   MaxScale = 20,   Unit_text =  "V"},
        ...
        new PicoProbeScaling(){ ProbeEnum = PicoConnectProbes.PicoConnectProbes.PicoConnectProbeRange.PICO_DIFFERENTIAL_20V, Probe_Range_text = "DIFFERENTIAL_20V",    MinScale = -20,   MaxScale = 20,   Unit_text =  "V"},

/**************************************************************************
 *
 * Filename: PS3000AStreamingMode.cs
 *
 * Description:
...
namespace PS3000AStreamingMode
{
    ...
    class PS3000AStreamingMode
    {
        ...
        ****************************************************************************/
        ...
        {
            Console.WriteLine("PicoScope 3000 Series (ps3000a) Driver C# streaming mode example");
            Console.WriteLine("\nOpening the device...");
            ...
            PS3000AStreamingMode streamingcapture = new PS3000AStreamingMode(handle);
            streamingcapture.getdeviceinfo();
        }
        public PS3000AStreamingMode(short handle)
        {
            _handle = handle;
        }

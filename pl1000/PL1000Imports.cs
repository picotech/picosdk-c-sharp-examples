...
namespace PL1000Imports
{
  public class Imports
  {
    ...
    public static extern StandardDriverStatusCode GetValue(short handle,
                                                           ushort[] value,
                                                           ref uint noOfValues,
                                                           out ushort overflow,
    ...
    public static extern StandardDriverStatusCode MaxValue(short handle,
                                                           out ushort maxvalue);
    ...
    public static extern StandardDriverStatusCode SetDo(short handle,
                                                        short do_value,
                                                        short DOchannel);

    [DllImport(_DRIVER_FILENAME, EntryPoint = "pl1000SetInterval")]
    public static extern StandardDriverStatusCode SetInterval(short handle,
                                                              ref uint usforblock,
